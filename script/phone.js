...
var inputGet = document.querySelector("#tel-input-get");
var iti = window.intlTelInput(input,  {
  utilsScript: "https://cdn.jsdelivr.net/npm/intl-tel-input@16.0.3/build/js/utils.js",
});
var itiGet = window.intlTelInput(inputGet,  {
  utilsScript: "https://cdn.jsdelivr.net/npm/intl-tel-input@16.0.3/build/js/utils.js",
});
...
function checkPhoneValidation(element, isValidNumber)
{
  ...
  let invFeedbackDiv = element.parents('.form-row').find('.invalid-feedback');
  input = element.get(0);
